...
void loop(void) {
  ...
  if (success)
  {
    ...
    if (!success)
    {
      Serial.println("fallo la key para el bloque cero!");
      return;
    }*/
    ...
    if (!success)
    {
      Serial.println("Fallo autenticacion para el primer bloque del sector 4.");
      return;
    }

    // Try to write a URL
    Serial.println("Escribiendo url al sector 1");
    ...
    if (success)
    {
      Serial.println("Se escribio en el sector 1");
